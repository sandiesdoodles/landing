...
window.SANDIES = {
  ...
  pricing: {
    label: "Profiles are live. $500 deposits open next for approved families.",
    base: 3800,
    deposit: 500,
    currency: "USD",
    ...
    tiers: [
      { name: "Companion", price: 3500, note: "Great coat & temperament" },
      { name: "Standard", price: 3800, note: "Most families land here" },
      { name: "First pick", price: 4000, note: "Priority choice by deposit time" },
    ],
  },
  transport: {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: "Profiles are up now. Deposits open next for approved families on the early list.",
    },
    {
  ...
  litter2: [
    {
      ...
      status: "available",
      blurb:
        "Lime-collar boy — warm apricot curls, pale muzzle, and a confident little stare.",
    },
    {
      id: "oakley",
      name: "Oakley",
      ...
      status: "available",
      blurb:
        "Boy with the white forehead blaze — warm curls and a soft, steady look.",
    },
    {
      id: "delilah",
      name: "Delilah",
      ...
      status: "available",
      blurb:
        "Cyan-collar girl — soft apricot curls and a calm, sweet little face.",
    },
    {
      id: "violet",
      name: "Violet",
      ...
      status: "available",
      blurb:
        "Purple-collar girl — warm apricot curls with a gentle, affectionate look.",
    },
    {
      id: "cedar",
      name: "Cedar",
      ...
      status: "available",
      blurb:
        "Dark-collar boy — calm apricot curls with a soft white snout.",
    },
    {
      id: "ginger",
      name: "Ginger",
      ...
      status: "available",
      blurb:
        "Red-collar girl — warm apricot curls with bright eyes and a playful spark.",
    },
    {
      id: "lotus",
      name: "Lotus",
      ...
      status: "available",
      blurb:
        "Yellow-collar girl — warm apricot curls, cream muzzle, and a soft curious head tilt.",
    },
    {
      id: "meadow",
      name: "Meadow",
      ...
      status: "available",
      blurb:
        "Pink-collar girl — warm apricot curls and a calm, grounded little face.",
    },
  ],
  pups: [
    {
